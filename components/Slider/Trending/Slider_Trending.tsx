...
import { Trending } from "@/action"; // Adjust this import as per your actual path
            ...
            >
              <CardBody className="overflow-visible p-0">
                <div className="relative">
                  ...
                  <p className="absolute top-0 left-0 text-white text-[12px] font-bold bg-[#333333] z-20 origin-left  hover:bg-primary ease-in-out duration-300">
                    {slide.SubHeading}
                  </p>
                </div>
              </CardBody>
...
export default Slider_Trending;
